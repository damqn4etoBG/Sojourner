...
public abstract class AbstractSojournerContainerMenu extends AbstractContainerMenu {
    protected AbstractSojournerContainerMenu(@Nullable MenuType<?> pMenuType, int pContainerId) {
